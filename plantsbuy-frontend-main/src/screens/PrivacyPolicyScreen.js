...
export default function PrivacyPolicyScreen() {
  return (
    <Container className="policy">
      <h1>PlantsBuy Privacy Policy</h1>

      <h5>
        PlantsBuy Privacy Policy This Privacy Policy describes how your personal
        information is collected, used, and shared when you visit or make a
        purchase from PlantsBuy is an ecommerce platform where various types of
        indoor and outdoor plants are available to sell. (the “Site”).
        <br />
        <br />
        ...
        campaigns). We share your Personal Information with third parties to
        help us use your Personal Information, as described above. For example,
        ...
        <br /> <br />
        <h3>MINORS </h3>
        The Site is intended for individuals from all age groups
        <br /> <br />
        <h3>CHANGES</h3>
        ...
        <strong>
          {" "}
          sushilrindhe29@gmail.com or by mail using the details provided below:
          Vyankatesh nagar , Chikhli, MH, 443201, India{" "}
        </strong>
        <br />
        <br />
        <br />
