...
export default function TermScreen() {
  return (
    <Container className="policy termsPolicy">
      <h1> TERMS OF SERVICE</h1>
      This website is operated by PlantsBuy. Throughout the site, the terms
      “we”, “us” and “our” refer to PlantsBuy. PlantsBuy offers this website,
      ...
      vendors, customers, merchants, and/ or contributors of content.Please read
      ...
      platform that allows us to sell our products and services to you. <br />
      <strong> SECTION 1 </strong> - ONLINE STORE TERMS By agreeing to these
      Terms of Service, you represent that you are at least the age of majority
      in your state or province of residence, or that you are the age of
      ...
      not use our products for any illegal or unauthorized purpose nor may you,
      ...
      your Services.
      <br />
      <strong> SECTION 2 </strong> - GENERAL CONDITIONS We reserve the right to
      ...
      transfer over networks. You agree not to reproduce, duplicate, copy, sell,
      ...
      headings used in this agreement are included for convenience only and will
      not limit or otherwise affect these Terms.
      <br />
      <strong> SECTION 3</strong> - ACCURACY, COMPLETENESS AND TIMELINESS OF
      INFORMATION We are not responsible if information made available on this
      ...
      <br />
      <strong> SECTION 4</strong> - MODIFICATIONS TO THE SERVICE AND PRICES
      ...
      <br />
      <strong> SECTION 5 </strong> - PRODUCTS OR SERVICES (if applicable)
      ...
      your computer monitor's display of any color will be accurate.We reserve
      ...
      notice, at the sole discretion of us. We reserve the right to discontinue
      any product at any time. Any offer for any product or service made on this
      site is void where prohibited. We do not warrant that the quality of any
      products, services, information, or other material purchased or obtained
      by you will meet your expectations, or that any errors in the Service will
      be corrected.
      <br />
      <strong> SECTION 6</strong> - ACCURACY OF BILLING AND ACCOUNT INFORMATION
      ...
      <br />
      <strong> SECTION 7</strong> - OPTIONAL TOOLS We may provide you with
      ...
      and/or services shall also be subject to these Terms of Service. <br />
      <strong> SECTION 8</strong> - THIRD-PARTY LINKS Certain content, products
      ...
      <br /> <strong> SECTION 9</strong> - USER COMMENTS, FEEDBACK AND OTHER
      SUBMISSIONS If, at our request, you send certain specific submissions (for
      ...
      (3) to respond to any comments.We may, but have no obligation to, monitor,
      ...
      <strong> SECTION 10</strong>- PERSONAL INFORMATION Your submission of
      personal information through the store is governed by our Privacy Policy.
      To view our Privacy Policy.
      <br />
      <strong> SECTION 11</strong> - ERRORS, INACCURACIES AND OMISSIONS
      ...
      <br />
      <strong> SECTION 12</strong> - PROHIBITED USES In addition to other
      ...
      <br />
      <strong> SECTION 13</strong>- DISCLAIMER OF WARRANTIES; LIMITATION OF
      LIABILITY We do not guarantee, represent or warrant that your use of our
      ...
      durability, title, and non-infringement.In no case shall PlantsBuy, our
      ...
      permitted by law.
      <br /> <strong> SECTION 14</strong> - INDEMNIFICATION You agree to
      indemnify, defend and hold harmless PlantsBuy and our parent,
      ...
      <br />
      <strong> SECTION 15 </strong> - SEVERABILITY In the event that any
      ...
      <br /> <strong> SECTION 16 </strong> - TERMINATION The obligations and
      ...
      no longer wish to use our Services, or when you cease using our site.If in
      ...
      thereof).
      <br /> <strong> SECTION 17 </strong> - ENTIRE AGREEMENT The failure of us
      ...
      <br /> <strong> SECTION 18</strong>- GOVERNING LAW These Terms of Service
      and any separate agreements whereby we provide you Services shall be
      governed by and construed in accordance with the laws of Vyankatesh nagar,
      Chikhli, MH, 443201, India. <br />
      <strong> SECTION 19</strong> - CHANGES TO TERMS OF SERVICE You can review
      ...
      20 - CONTACT INFORMATION Questions about the Terms of Service should be
      sent to us at sushilrindhe29@gmail.com.
    </Container>
  );
}
