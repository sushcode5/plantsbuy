  ...
  return (
    <Container className="policy">
      ...
      <h5>
        ...
        items: * Gift cards * Downloadable software products * Some health and
        personal care items To complete your return, we require a receipt or
        proof of purchase. Please do not send your purchase back to the
        manufacturer. There are certain situations where only partial refunds
        are granted: * Any item not in its original condition, is damaged or
        missing parts for reasons not due to our error. * Any item that is
        returned more than 30 days after delivery Refunds (if applicable) Once
        ...
        <strong> sushilrindhe29@gmail.com </strong>.Sale items (if applicable)
        Only regular priced items may be refunded, unfortunately sale items
        cannot be refunded. Exchanges (if applicable) We only replace items if
        they are defective or damaged. If you need to exchange it for the same
        item, send us an email at <strong>sushilrindhe29@gmail.com</strong> and
        send your item to:
        <strong> Vyankatesh nagar, Chikhli, MH, 443201, India</strong>. Gifts If
        the item was marked as a gift when purchased and shipped directly to
        ...
        <strong> Vyankatesh nagar, Chikhli, MH, 443201, India</strong>. You will
        be responsible for paying for your own shipping costs for returning your
        ...
        you, may vary. If you are shipping an item over Rs.75, you should
